...
TweenMax.set('.sceneTween2',{display:'none'});
imageTween('.rnd-imgTween');
...
// stage content:
(lib.mhero = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(22).to({_off:false},0).to({regX:0,regY:0,scaleX:1,scaleY:1,x:457.3,y:253.6,alpha:1},13,cjs.Ease.circIn).wait(19).to({startPosition:0},0).to({scaleX:0.79,scaleY:0.79,x:476.7,y:275.9},9).wait(375));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(28).to({_off:false},0).to({regY:0,scaleX:1,scaleY:1,y:245.9,alpha:1},13,cjs.Ease.circIn).wait(13).to({startPosition:0},0).to({scaleX:0.79,scaleY:0.79,x:585.3,y:269.8},9).wait(375));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(33).to({_off:false},0).to({scaleX:1,scaleY:1,alpha:1},12,cjs.Ease.circIn).wait(9).to({startPosition:0},0).to({scaleX:0.79,scaleY:0.79,x:693.7,y:268.3},9).wait(375));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(39).to({_off:false},0).to({scaleX:1,scaleY:1,alpha:1},11,cjs.Ease.circIn).wait(4).to({startPosition:0},0).to({scaleX:0.79,scaleY:0.79,x:612.7,y:341},9).wait(375));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(37).to({_off:false},0).to({scaleX:1,scaleY:1,rotation:360,alpha:0.941},17,cjs.Ease.quadIn).to({regY:0.1,scaleX:0.46,scaleY:0.46,x:587.7,y:114.1},9).wait(375));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"img/hero/hero_title1.png?1508133815802", id:"hero_title1"},
		{src:"img/hero/hero_title2.png?1508133815802", id:"hero_title2"},
		{src:"img/hero/hero_title3.png?1508133815802", id:"hero_title3"},
		{src:"img/hero/hero_title4.png?1508133815802", id:"hero_title4"},
		{src:"img/hero/kanarb.png?1508133815802", id:"kanarb"},
		{src:"img/hero/map_greydot.png?1508133815802", id:"map_greydot"},
		{src:"img/hero/map_orangedot.png?1508133815802", id:"map_orangedot"}
	],
	preloads: []
};
